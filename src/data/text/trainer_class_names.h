const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_AQUA_LEADER]         = _("BOSS"),
    ...
    [TRAINER_CLASS_RICH_BOY]            = _("BARON"),
    ...
    [TRAINER_CLASS_RS_ELITE_FOUR]       = _("BOSS"),
    [TRAINER_CLASS_RS_LEADER]           = _("{PKMN} TRAINER"),
    ...
    [TRAINER_CLASS_RS_CHAMPION]         = _("{PKMN} TRAINER"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER]        = _("{PKMN} TRAINER"),
    ...
    [TRAINER_CLASS_MYSTERY_GIRL]        = _("MYSTERY GIRL"),
    [TRAINER_CLASS_TOWER_TYCOON]        = _("TOWER TYCOON"),
};
