static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_CINNABAR_ISLAND - 1] = {MAP_GROUP(CINNABAR_ISLAND), MAP_NUM(CINNABAR_ISLAND), 16, 21},
    ...
    [SPAWN_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER), MAP_NUM(MT_SILVER), 20, 10},
    [SPAWN_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 11, 11},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER_POKE_CENTER), MAP_NUM(MT_SILVER_POKE_CENTER)},
    [SPAWN_NEW_BARK_TOWN - 1] = {MAP_GROUP(ELMS_LAB), MAP_NUM(ELMS_LAB)},
};
