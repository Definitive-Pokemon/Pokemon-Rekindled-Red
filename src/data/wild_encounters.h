...
const struct WildPokemonHeader gWildMonHeaders[] =
{
	...
	{
        .mapGroup = MAP_GROUP(MT_SILVER_CAVE_OUTDOOR1),
        .mapNum = MAP_NUM(MT_SILVER_CAVE_OUTDOOR1),
	...
	{
        .mapGroup = MAP_GROUP(MT_SILVER_CAVE_OUTDOOR2),
        .mapNum = MAP_NUM(MT_SILVER_CAVE_OUTDOOR2),
