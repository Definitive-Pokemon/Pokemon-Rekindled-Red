...
const u32 gTrainerFrontPic_LeaderWinona[] = INCBIN_U32("graphics/trainers/front_pics/leader_daisy_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderWinona[] = INCBIN_U32("graphics/trainers/palettes/leader_daisy.gbapal.lz");

const u32 gTrainerFrontPic_LeaderWallace[] = INCBIN_U32("graphics/trainers/front_pics/celio_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderWallace[] = INCBIN_U32("graphics/trainers/palettes/celio.gbapal.lz");
