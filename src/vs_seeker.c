...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_SWIMMER_FEMALE_SEDEF, SKIP, SKIP, SKIP, TRAINER_SWIMMER_FEMALE_SEDEF_2},
      MAP(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_ANDREW, SKIP, SKIP, SKIP, TRAINER_ANDREW},
      MAP(ROUTE27) },
   { {TRAINER_STEVE, SKIP, SKIP, SKIP, TRAINER_STEVE},
      MAP(ROUTE26) },
   { {TRAINER_ALEX, SKIP, SKIP, SKIP, TRAINER_ALEX},
      MAP(ROUTE27) },
   { {TRAINER_MARKBUG, SKIP, SKIP, SKIP, TRAINER_MARKBUG},
      MAP(ROUTE26) },
   { {TRAINER_JORN, SKIP, SKIP, SKIP, TRAINER_JORN},
      MAP(ROUTE26) },
   { {TRAINER_ANDRE, SKIP, SKIP, SKIP, TRAINER_ANDRE},
      MAP(ROUTE26) },
   { {TRAINER_WILL, SKIP, SKIP, SKIP, TRAINER_WILL},
      MAP(ROUTE26) },
   { {TRAINER_MARKYOUNG, SKIP, SKIP, SKIP, TRAINER_MARKYOUNG},
      MAP(ROUTE26) },
